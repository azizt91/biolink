            ...
            {links.length === 0 ? (
                ...
                <div className="space-y-3">
                    {links.map((link, index) => (
                        <div
                            key={link.id}
                            className={`bg-white/5 backdrop-blur-xl rounded-2xl p-3 sm:p-4 border transition-all ${link.is_active ? 'border-white/10' : 'border-white/5 opacity-60'
                                }`}
                        >
                            <div className="flex items-center gap-2 sm:gap-4">
                                ...
                                <div className="flex items-center gap-1 shrink-0">
                                    ...
                                    <button
                                        ...
                                        className={`p-1.5 sm:p-2 rounded-lg transition-colors ${link.is_active
                                    ...
                                    <button
                                        ...
                                        className="p-1.5 sm:p-2 text-red-400 hover:text-red-300 hover:bg-red-500/20 rounded-lg transition-colors"
                                        title="Hapus"
                                    >
                                        <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
